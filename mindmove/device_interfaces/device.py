...
import psutil
import logging
from PySide6.QtCore import QIODevice, QObject, QByteArray, Signal
import numpy as np
import re

# Local Libraries
from mindmove.device_interfaces.enums.device import Device, CommunicationProtocol, LoggerLevel
...
class BaseDevice(QObject):
    ...
    def get_server_wifi_ip_address(self) -> str:
        """
        ...
        try:
            ...
            print(e)
            self.log_info(
                f"This machine does not have any WiFi network adapters!",
                LoggerLevel.ERROR,
            )
            return None
